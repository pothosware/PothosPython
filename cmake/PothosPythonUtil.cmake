...
set(POTHOS_PYTHON_DIR ${POTHOS_PYTHON_DIR} CACHE PATH "python install prefix")

set(POTHOS_PYVER "${PYTHON_VERSION_MAJOR}${PYTHON_VERSION_MINOR}")
message(STATUS "POTHOS_PYVER: ${POTHOS_PYVER}")
